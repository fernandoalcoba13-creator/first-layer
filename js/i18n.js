const TXT={
  es:{
    ...
    cleanerDesc:'Resuelve boquilla tapada o blob.',
    use:'Usar',missingMaterial:'falta material',noQueuedOrders:'Sin pedidos en cola.',
    consHint:'Cafe recupera energia y activa turbo corto. La barrita baja estres. Limpia pico resuelve boquilla tapada o blob durante la noche.'
    ...
    firstPrintTip:'Tip: hace click en una impresora libre, o acercate y apreta E.',
  ...
  en:{
    ...
    cleanerDesc:'Solves clogs or blobs.',
    use:'Use',missingMaterial:'missing material',noQueuedOrders:'No queued orders.',
    consHint:'Coffee restores energy and triggers short turbo. Cereal bars reduce stress. Nozzle wipes solve clogs or blobs during night shift.',
    ...
    firstPrintTip:'Tip: click a free printer, or walk nearby and press E.',
