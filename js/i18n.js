const TXT={
  es:{
    ...
    repGoalLabel:'Objetivo del día: mantené tu fama',tryAgain:'probá de nuevo',repairAnyway:'Reparar igual',
    repBadNote:'los clientes pagan menos, tienen menos paciencia y llegan más lento.',
    ...
    move:'Mover / click directo',interact:'Click o E',closePause:'Cerrar / pausa',acceptOrder:'Aceptar pedido',
    negotiate:'Negociar',reject:'Rechazar',repair:'Reparar',mate:'Mate',
    continue:'CONTINUAR',reset:'BORRAR PARTIDA',
    objective:'Objetivo: hacer crecer tu taller sin fundirte ni quemar las maquinas.',
    ...
    coffee:'Cafe de turno',mateConsumable:'Mate listo',bar:'Barrita cereal',sandwich:'Sandwich',cleaner:'Aguja destapadora',
    coffeeDesc:'+30 energia y turbo corto.',
    mateDesc:'+40 energia y turbo largo.',
    barDesc:'+20 energia y baja estres.',
    sandwichDesc:'+35 energia y baja mucho estres.',
    cleanerDesc:'Herramienta para limpiar boquillas.',
    use:'Usar',missingMaterial:'falta material',noQueuedOrders:'Sin pedidos en cola.',
    consHint:'Usa consumibles para recuperar ritmo. Cafe y mate activan turbo; comida baja estres. La aguja se usa en el minijuego de boquilla.',
    owned:'Tenes',available:'Disponible',missingStock:'Sin stock',
    ...
    manualNightHint:'Elegí una impresora libre y cargá un trabajo pendiente.',
    ...
    cheapPlaRisk:'El PLA eco rinde, pero tapa mas la boquilla y sufre humedad.',
    ...
    dayOneShopTip:'Primer pedido aceptado: compra PLA Basic en tienda para poder imprimirlo.',
    dayOneLoadTip:'PLA listo. Ahora carga el pedido en la impresora libre.',
    dayOnePrintTip:'La impresora ya trabaja. Atende algun pedido mas o preparate para la noche.',
    dayOneNightJobTip:'Este trabajo queda preparado para la noche.',
    ...
    choosePrinterJob:'Elegi una impresora libre y carga un trabajo con click o E.',noOrdersToPrint:'Sin pedidos en cola para imprimir.',
    assignHint:'Click en impresora | E cerca',jobLoaded:'Ese trabajo ya esta cargado.',
    ...
    dayLoadPrinterDesc:'Elegí qué trabajo mandar a P1. Las demas quedan reservadas para la noche.',
    dayPrinterLimit:'Durante el dia solo P1 imprime. Las demas trabajan en la noche.',
    firstPrintTip:'Tip: primero compra PLA Basic en tienda, despues carga la impresora.',
    ...
    cost:'Costo',autoRepair:'Rodrigo repara solo',nozzleMini:'Minijuego: limpiar pico',ignore:'Ignorar',cleanNozzle:'Usar aguja',
  ...
  en:{
    ...
    repGoalLabel:'Daily goal: keep your fame',tryAgain:'try again',repairAnyway:'Repair anyway',
    repBadNote:'clients pay less, have less patience, and arrive slower.',
    ...
    move:'Move / direct click',interact:'Click or E',closePause:'Close / pause',acceptOrder:'Accept order',
    negotiate:'Negotiate',reject:'Reject',repair:'Repair',mate:'Mate',
    continue:'CONTINUE',reset:'DELETE SAVE',
    objective:'Goal: grow your workshop without going broke or burning machines.',
    ...
    coffee:'Shift coffee',mateConsumable:'Ready mate',bar:'Cereal bar',sandwich:'Sandwich',cleaner:'Nozzle needle',
    coffeeDesc:'+30 energy and short turbo.',
    mateDesc:'+40 energy and long turbo.',
    barDesc:'+20 energy and lowers stress.',
    sandwichDesc:'+35 energy and lowers stress a lot.',
    cleanerDesc:'Tool for cleaning nozzles.',
    use:'Use',missingMaterial:'missing material',noQueuedOrders:'No queued orders.',
    consHint:'Use consumables to recover pace. Coffee and mate trigger turbo; food lowers stress. The needle is used in the nozzle mini-game.',
    owned:'Owned',available:'Available',missingStock:'No stock',
    ...
    manualNightHint:'Choose a free printer and load a pending job.',
    ...
    cheapPlaRisk:'Eco PLA stretches cash, but clogs more and hates humidity.',
    ...
    dayOneShopTip:'First order accepted: buy PLA Basic in the shop so you can print it.',
    dayOneLoadTip:'PLA ready. Now load the order into the free printer.',
    dayOnePrintTip:'The printer is working. Serve one more order or prepare for night.',
    dayOneNightJobTip:'This job is prepared for the night shift.',
    ...
    choosePrinterJob:'Choose a free printer and load a job with click or E.',noOrdersToPrint:'No queued jobs to print.',
    assignHint:'Click printer | E nearby',jobLoaded:'That job is already loaded.',
    ...
    dayLoadPrinterDesc:'Choose which job to send to P1. The other printers are reserved for night.',
    dayPrinterLimit:'During the day only P1 prints. The others work at night.',
    firstPrintTip:'Tip: buy PLA Basic in the shop first, then load the printer.',
    ...
    cost:'Cost',autoRepair:'Rodrigo fixes it',nozzleMini:'Mini-game: clean nozzle',ignore:'Ignore',cleanNozzle:'Use needle',
