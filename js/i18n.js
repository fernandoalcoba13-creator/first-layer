const TXT={
  es:{
    ...
    firstPrintTip:'Tip: acercate a una impresora libre y apretá E para cargar el pedido.',
  ...
  en:{
    ...
    firstPrintTip:'Tip: walk to a free printer and press E to load the order.',
