...
const BETA_DAYS={
  1:{title:'La apertura',goal:'Ganá $300',duration:75000,maxClients:3,firstSpawn:1600,secondSpawn:9000,interval:15000,shop:['pla:eco','petg:eco','coffee','mate'],forcedPower:[],forcedFails:[{at:9000,id:'clog'}],hint:'Tutorial: aceptá pedidos, cargá una impresora y comprá PLA/PETG Basic. Lo barato tapa más la boquilla.'},
  2:{title:'Primera presión',goal:'Aceptá 4 pedidos',duration:115000,maxClients:5,firstSpawn:1200,secondSpawn:8000,interval:16000,shop:['pla:eco','pla:std','petg:eco','parts','coffee','mate','bar'],forcedPower:[{at:12000,id:'micro'},{at:33000,id:'norm'}],forcedFails:[{at:18000,id:'bed'}],hint:'El stock importa: si aceptás sin material, el pedido espera hasta comprarlo.'},
  3:{title:'El quiebre',goal:'Sobreviví la noche con 2 impresoras funcionando',duration:140000,maxClients:7,firstSpawn:1200,secondSpawn:6500,interval:13000,shop:['pla:eco','pla:std','pla:pro','petg:eco','petg:std','petg:pro','tpu:basic','resin:basic','parts','unlock2','coffee','mate','bar','sandwich','cleaner'],forcedPower:[{at:14000,id:'long'}],forcedFails:[{at:22000,id:'random'},{at:42000,id:'random'}],hint:'Comprá la segunda impresora y cargá trabajos temprano para maximizar producción.'}
};
const UPG=[
